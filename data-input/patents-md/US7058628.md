...
assigning a score to each of the linked documents based on scores associated with the one or more linking documents; and
processing the linked documents according to the assigned scores.
2. A computer implemented method of scoring a plurality of documents, comprising:
...
Description
  ...
  This application is a continuation, of application Ser. No. 09/004,827, filed Jan. 9, 1998, which claims the benefit of Provisional Application No. 60/035,205, filed Jan. 10, 1997.
...
r(A)=n. 
  ...
  In one aspect of the invention, a computer implemented method is provided for scoring linked documents. The method includes identifying a plurality of documents, at least some of the documents being linked documents, at least some of the documents being linking documents, and at least some o
