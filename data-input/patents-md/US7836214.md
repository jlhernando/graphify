...
## Claims
1. A computer-readable program product comprising:
...
(A2) a configuration mapping mechanism that maps at least one configuration setting for at least one computer system to the model configuration settings, wherein the configuration mapping mechanism maps the at least one configuration setting for a selected platform to corresponding configuration settings for a different platform; and

(B) computer-readable signal bearing recordable media bearing the system configuration manager.
2. The program product of claim 1 wherein the at least one configuration setting comprises system settings and customization settings.
3. The program product of claim 1 wherein the system configuration manager further comprises a computer program that runs on each at least one computer system and that reports status of any requested update of configuration settings.
...
Description
    ...
    This patent application is a continuation of U.S. Ser. No. 11/375,445 filed on Mar. 14, 2006, which is a continuation of U.S. Ser. No. 09/879,510 filed on Jun. 12, 2001, which issued as U.S. Pat. No. 7,171,458 on Jan. 30, 2007. Both of these parent applications are incorporated herein by reference.
    ...
    One example of a prior art configuration 100 for network administration is shown in FIG. 1. In this
