...
(A) a server computer system comprising:
model configuration settings that specify desired operating system and customization settings for a computer system; and
...
(B) a plurality of endpoint computer systems coupled to the server computer system, each endpoint computer system including corresponding configuration settings; and
...
2. The networked computer system of claim 1 wherein the configuration mapping mechanism maps at least one configuration setting in a first computer platform to at least one corresponding configuration setting in a second computer platform and wherein the first computer platform is a different type than the second computer platform.
3. The networked computer system of claim 1 wherein the customization settings are selected from the following: settings that determine how a software application runs, settings for a graphical user interface desktop, and bookmarks in a web browser.
4. The networked computer system of claim 1 wherein the model configuration settings are generic settings that are not specific to any particular computing platform, and the configuration mapping mechanism compares the model settings to corresponding configuration settings in the selected endpoint computer system.
5. A networked computer system comprising:
(A) a server computer system comprising:
model configuration settings that specify desired operating system and customization settings for a computer system, wherein the model configuration settings are generic settings that are not specific to any particular computing platform, and the configuration mapping mechanism compares the model settings to corresponding configuration settings in the selected endpoint computer system; and
a configuration mapping mechanism that maps at least one configuration setting for at least one computer system to the model configuration settings;
...
Description
  ...
  This patent application is a divisional of a U.S. patent application of the same title filed by the same inventors, Ser. No. 11/375,455 filed on Mar. 14, 2006, which is a continuation of a U.S. patent application of the same title filed by the same inventors, Ser. No. 09/879,510 filed on Jun. 12, 2001. Both of these related patent applications are incorporated herein by reference.
  ...
  One example of a prior art configuration 100 for network administration is shown in FIG. 1. In this exa
